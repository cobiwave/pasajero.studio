...
class Service {
  ...
  generateNav(queryNavResult: ApolloQueryResult<NavigationQuery>): NavContent {
    return {
      menu:
  ...
  generateFooter(queryFooterResult: ApolloQueryResult<NavigationQuery>): FooterContent {
    return {
      siteMap: {
      ...
      copyright: queryFooterResult.data?.navigation?.copyright || '',
    };
  }
