...
export function childrenAreEqual(previousChildren: ReactElement | null, nextChildren: ReactElement | null): boolean {
  if (previousChildren === nextChildren) return true
