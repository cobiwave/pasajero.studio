...
module.exports = function (
  ...
  plop.setGenerator('cta', {
    description: 'create a cta component',
    prompts: [{ type: 'input', name: 'name', message: 'Type the component name:' }],
    actions: [...addComponentFiles('{{titleCase name}}', 'cta')]
  });
};
